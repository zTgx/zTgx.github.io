...
```go
ipfs-cluster-service init
ipfs-cluster-service daemon --bootstrap /ip4/118.190.39.87/tcp/9096/ipfs/12D3KooWNKoBqPbe5wQLm5nmRQB5mqRB3wpU8zU7dpbfemiuPEbA(此处是 cluster 的 peerid)
```
