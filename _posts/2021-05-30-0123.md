---
layout: post
title: tonic版的Helloworld
date: 2021-05-30
category: docker
---

本来想翻译一下，不过文档写的简单明了，翻译就多余了。 这里直接 copy 过来了[^1]。  
...
[^1]: [Helloworld](https://github.com/hyperium/tonic/blob/master/examples/helloworld-tutorial.md).  
[^2]: [A beginners guide to gRPC with Rust](https://dev.to/anshulgoyal15/a-beginners-guide-to-grpc-with-rust-3c7o).